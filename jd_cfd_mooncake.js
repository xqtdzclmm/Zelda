/*
京喜财富岛合成月饼
cron 10 6,13,23 * * * jd_cfd_mooncake.js
更新时间：2021-9-11
活动入口：京喜APP-我的-京喜财富岛
...
[task_local]
#京喜财富岛合成月饼
10 6,13,23 * * * https://raw.githubusercontent.com/Aaron-lv/sync/jd_scripts/jd_cfd_mooncake.js, tag=京喜财富岛合成月饼, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jxcfd.png, enabled=true

================Loon==============
[Script]
cron "10 6,13,23 * * *" script-path=https://raw.githubusercontent.com/Aaron-lv/sync/jd_scripts/jd_cfd_mooncake.js,tag=京喜财富岛合成月饼

===============Surge=================
京喜财富岛合成月饼 = type=cron,cronexp="10 6,13,23 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/Aaron-lv/sync/jd_scripts/jd_cfd_mooncake.js

============小火箭=========
京喜财富岛合成月饼 = type=cron,script-path=https://raw.githubusercontent.com/Aaron-lv/sync/jd_scripts/jd_cfd_mooncake.js, cronexpr="10 6,13,23 * * *", timeout=3600, enable=true
 */
      ...
      try {
        if (err) {
          ...
          if (showInvite && strMyShareId) {
            ...
            pool.log($.UserName,$.name,ENV_NAME,strMyShareId);
